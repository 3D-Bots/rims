...
export async function sendVerificationEmail(to: string, token: string): Promise<void> {
  ...
  await resend.emails.send({
    from: fromEmail,
    to,
    subject: 'Verify your email address - RIMS',
    html: `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #ffffff; padding: 30px; border: 1px solid #e0e0e0; border-top: none; border-radius: 0 0 10px 10px;">
          ...
          <p>Thanks for signing up for RIMS! Please click the button below to verify your email address and activate your account.</p>
          ...
          <p style="color: #999; font-size: 12px; margin-bottom: 0;">
            This link will expire in 24 hours. If you didn't create an account with RIMS, you can safely ignore this email.
          </p>
        </div>
      </body>
      </html>
    `,
    text: `
Verify your email address for RIMS

Thanks for signing up for RIMS! Please click the link below to verify your email address and activate your account:
